  ...
  describe(`#Request - generate 'path' and 'url' for admin access`, () => {
    it('should return -1 when the value is not equal', () => {
      ...
      fn(req, res, () => {
        ...
        expect(req.adminIndexPagesUrl()).to.deep.equal('http://127.0.0.1/admin/pages')
  ...
  describe(`#Responce - generate 'path' and 'url' for admin access`, () => {
    it('should return -1 when the value is not equal', () => {
      ...
      fn(req, res, () => {
        ...
        expect(res.locals.adminIndexPagesUrl()).to.deep.equal('http://127.0.0.1/admin/pages')
      })
  ...
  describe(`#Request - generate 'path' and 'url' for root access`, () => {
    it('should return -1 when the value is not equal', () => {
      ...
      fn2(req2, res2, () => {
        ...
        expect(req2.editPagesUrl(1)).to.deep.equal('http://127.0.0.1/pages/1/edit')
        ...
        expect(req2.trashPagesUrl(1)).to.deep.equal('http://127.0.0.1/pages/1/trash')
  ...
  describe(`#Responce - generate 'path' and 'url' for root access`, () => {
    it('should return -1 when the value is not equal', () => {
      ...
      fn2(req2, res2, () => {
        ...
        expect(res2.locals.indexPagesUrl()).to.deep.equal('http://127.0.0.1/pages')

        expect(res2.locals.editPagesPath({id: 1})).to.deep.equal('/pages/1/edit')
        expect(res2.locals.editPagesUrl({id: 1})).to.deep.equal('http://127.0.0.1/pages/1/edit')

        expect(res2.locals.showPagesPath(1)).to.deep.equal('/pages/1')
        expect(res2.locals.showPagesUrl(1)).to.deep.equal('http://127.0.0.1/pages/1')

        expect(res2.locals.newPagesPath(1)).to.deep.equal('/pages/new')
        expect(res2.locals.newPagesUrl(1)).to.deep.equal('http://127.0.0.1/pages/new')

        expect(res2.locals.createPagesPath(1)).to.deep.equal('/pages')
        expect(res2.locals.createPagesUrl(1)).to.deep.equal('http://127.0.0.1/pages')

        expect(res2.locals.updatePagesPath(1)).to.deep.equal('/pages/1')
        expect(res2.locals.updatePagesUrl(1)).to.deep.equal('http://127.0.0.1/pages/1')

        expect(res2.locals.deletePagesPath(1)).to.deep.equal('/pages/1')
        expect(res2.locals.deletePagesUrl(1)).to.deep.equal('http://127.0.0.1/pages/1')

        expect(res2.locals.trashPagesPath(1)).to.deep.equal('/pages/1/trash')
        expect(res2.locals.trashPagesUrl(1)).to.deep.equal('http://127.0.0.1/pages/1/trash')
      })
